...
tf.flags.DEFINE_float('max_epsilon', 10, 'max epsilon.')
tf.flags.DEFINE_integer('num_iter', 5, 'max iteration.')
...
tf.flags.DEFINE_string('checkpoint_path', 'checkpoint/', 'Path to checkpoint for pretained models.')
tf.flags.DEFINE_string('input_dir', 'dataset/', 'Input directory with images.')
tf.flags.DEFINE_string('output_dir', 'output/e10i5/', 'Output directory with images.')
