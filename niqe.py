...
if __name__ == "__main__":
    ref = np.array(Image.open(r'E:\OneDrive - hust.edu.cn\files\去雪\figure\结果\transweather\7.png').convert('LA'))[:, :, 0]  # ref
    dis = np.array(Image.open(r'E:\OneDrive - hust.edu.cn\files\去雪\figure\结果\transweather\8.png').convert('LA'))[:, :, 0]  # dis
